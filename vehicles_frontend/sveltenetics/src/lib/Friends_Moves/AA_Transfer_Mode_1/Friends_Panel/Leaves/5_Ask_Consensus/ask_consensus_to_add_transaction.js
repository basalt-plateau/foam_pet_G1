...
} from '$lib/Friends_Moves/AA_Transfer_Mode_1/Screenplays/hexadecimal_UT_to_Aptos_Object' 
import { 
	hexadecimal_Signature_to_Aptos_Object 
} from '$lib/Friends_Moves/AA_Transfer_Mode_1/Screenplays/hexadecimal_Signature_to_Aptos_Object' 
...
export const ask_consensus_to_add_transaction = async ({ freight }) => {
	try {
		...
		if (enhanced.success === true) {
			freight.ask_consensus.waiting_info = ""
			freight.ask_consensus.show_alert_success = "yes"
