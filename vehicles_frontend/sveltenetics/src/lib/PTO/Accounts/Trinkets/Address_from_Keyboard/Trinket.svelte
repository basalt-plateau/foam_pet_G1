...
//		@ Account
//
let directory_name = "Aptos Being 1"
$: {
...
<div address_from_keyboard_glyphs>
	...
	<div>
		...
		>These are the modifications that occur:</p>
		...
		>
			<div
				...
				"
			>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">W</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>0</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">E</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>1</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">R</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>2</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">T</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>3</span>
				</div>
			</div>
			...
			>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">Y</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>4</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">U</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>5</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">I</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>6</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">O</kbd>
					<span>=</span>
		...
		>
			...
			>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">S</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>8</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">D</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>9</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">F</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>A</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">G</kbd>
					<span>=</span>
			...
			>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">H</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>C</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">J</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>D</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">K</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>E</span>
				</div>
				<div style={ trends.keyboard_glyph_equivalent }>
					<kbd class="kbd">L</kbd>
					<span>=</span>
					<span style={ trends.keyboard_glyph_hexadecimal }>F</span>
				</div>
			</div>
		</div>
	...
	>
		...
		>
			Save <Slang text="Account" /> to the OS
		</button>
	</div>
</div>