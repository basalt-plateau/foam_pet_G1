...
const save = async () => {
	...
	const legacy_address_hexadecimal_string = single_key_legacy_address_hexadecimal_string;
	const fresh_address_hexadecimal_string = single_key_fresh_address_hexadecimal_string;
...
>
	...
	>
		...
		<button 
			disabled={ public_key_hexadecimal_string.length == 0 }
