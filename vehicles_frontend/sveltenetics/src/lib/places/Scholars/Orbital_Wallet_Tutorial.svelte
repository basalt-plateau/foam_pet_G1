...
const form_signature = '/pictures/orbital/form_signature.svg';
...
<div>
	...
	<div class="card p-2">
		...
		>
			<p>
				The <Slang text="Online Machine" /> and the <Slang text="Offline Machine" /> both need <Slang text="Label" />.
			</p>
		</div>
	</div>
	...
	<div class="card p-2">
		...
		<div
			...
			"
		>
			<img src={ form_petition } alt="Petition Formation" />
		</div>
	</div>
	...
	<div class="card p-2">
		...
		<div
			...
			"
		>
			<img src={ send_petition } alt="send petition" />
		</div>
	</div>
	...
	<div class="card p-2">
		...
		<div
			...
			"
		>
			<img src={ form_signature } alt="Signature Formation" />
		</div>
	</div>
	...
	<div class="card p-2">
		...
		<div
			...
			"
		>
			<img src={ send_signature } alt="move signature" />
		</div>
	</div>
	...
	<div class="card p-2">
		...
		<div
			...
			"
		>
			<img src={ form_note } alt="form note" />
		</div>
	</div>	
</div>